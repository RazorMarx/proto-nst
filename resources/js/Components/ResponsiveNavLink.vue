...
const classes = computed(() =>
    props.active
        ? 'block w-full pl-3 pr-4 py-2 border-l-4 border-nephele-dark text-left text-base font-medium text-nephele-dark bg-[#87B98833] focus:outline-none focus:text-nephele-dark focus:bg-[#87B98866] focus:border-nephele-dark transition duration-150 ease-in-out'
